 ...
 * @tparam max_entries Maximum number of entries per node. Defaults to 10.
 * @tparam grid_exp_min Minimum node grid size (2 ^ min_grid_exp). Defaults to 2.
 * @tparam grid_exp_max Initial grid size of the root. (2 ^ root_grid_exp). Defaults to 10.
 * @tparam GetBox Tells the RTree how to fetch the associated volume for a value.
 * @tparam GetID Tells the RTree how to fetch the associated ID for a value
 */
template <U64 N, typename Value, U64 max_entries = 10, U64 grid_exp_min = 2, U64 grid_exp_max = 10,
